...
4. Postgres — **Amazon RDS in Mumbai (`ap-south-1`)**. Click-by-click: `docs/AWS_RDS.md`.
   - [ ] Send `DATABASE_URL` privately after the instance is Available
   - Fallback only: Neon `aws-ap-south-1` or Fly Postgres in `bom`
